...
# HIHO_DATA_HOME mirrors the addon's "HIHO data home" preference. Set it in
# ~/.zshenv to save takes somewhere other than the Desktop; quotes matter,
# folder names can contain & and spaces.
OUT_ROOT="${HIHO_DATA_HOME:-$HOME/Desktop}"
OUT="$OUT_ROOT/HIHO_CAPTURES/$STAMP"
CAMS="${1:-0,1,2,3,4,5}"
DUR="${2:-60}"
...
if "/Users/davidbayus/miniforge3/envs/freemocap-env/bin/python" \
  ...
  echo "$OUT" > "$OUT_ROOT/HIHO_LAST_CAPTURE.txt"
  echo ""
